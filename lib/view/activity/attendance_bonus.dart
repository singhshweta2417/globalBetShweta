...
import 'package:game_on/view/activity/attendance_rule.dart';
import 'package:game_on/view/activity/attendance_history.dart';
...
class _AttendenceBonusState extends State<AttendenceBonus> {
  ...
  Future<void> attendenceList() async {
    ...
    if (response.statusCode == 200) {
      ...
      attendancesConsecutively =
          json.decode(response.body)['attendances_consecutively'].toString();
      setState(() {
        attendenceItems =
