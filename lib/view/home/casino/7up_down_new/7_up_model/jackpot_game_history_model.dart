class JackpotGameHistoryModel {
  dynamic status;
  dynamic message;
  dynamic totalBets;
  List<Data>? data;

  JackpotGameHistoryModel(
      {this.status, this.message, this.totalBets, this.data});

  JackpotGameHistoryModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
