...
class DualRingAnimation extends StatefulWidget {
  const DualRingAnimation({
    Key? key,
    required this.color,
    this.lineWidth = 7.0,
    this.size = 50.0,
  ...
  @override
  State<DualRingAnimation> createState() => _DualRingAnimationState();
}

class _DualRingAnimationState extends State<DualRingAnimation> with SingleTickerProviderStateMixin {
