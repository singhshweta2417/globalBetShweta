              ...
              l12hvm.lucky12HistoryModel!.data!.length,
                ...
                return l12hvm.lucky12HistoryModel!.data!.isNotEmpty?Row(
                    ...
                    children: [
                      ...
                      commonWidget('${l12hvm.lucky12HistoryModel!.data![index].periodNo}', height * 0.45,
                          fotSize: 20
                      ),
                      commonWidget('${l12hvm.lucky12HistoryModel!.data![index].amount}', height * 0.2,
                          fotSize: 20
                      ),
                      commonWidget('${l12hvm.lucky12HistoryModel!.data![index].winAmount}', height * 0.2,
                          fotSize: 20
                      ),
