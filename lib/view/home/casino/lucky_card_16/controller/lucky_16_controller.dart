...
class Lucky16Controller with ChangeNotifier {
  ...
  void doubleAllBets(context) {
    ...
    int totalRequiredBalance =
        addLucky16Bets.fold(0, (sum, bet) => sum + bet['amount']!);
  ...
  void removeRowBet(BuildContext context, int rowIndex) {
    ...
    if (rowRemoveIndex != -1) {
      ...
      for (var bet in rowBet) {
        ...
        totalBetAmount -= amount;
        profileViewModel.addBalance(amount); //addBalance
      }
    }
  ...
  List<GridAllModel> cardList = [
    GridAllModel(image: Assets.lucky16HartA, id: 1),
    GridAllModel(image: Assets.lucky16HukumA, id: 2),
    GridAllModel(image: Assets.lucky16EtaA, id: 3),
    GridAllModel(image: Assets.lucky16ChidiA, id: 4),
    GridAllModel(image: Assets.lucky16HeartK, id: 5),
    GridAllModel(image: Assets.lucky16HukumK, id: 6),
    GridAllModel(image: Assets.lucky16EtaK, id: 7),
    GridAllModel(image: Assets.lucky16ChidiK, id: 8),
    GridAllModel(image: Assets.lucky16HeartQ, id: 9),
    GridAllModel(image: Assets.lucky16HukumQ, id: 10),
    GridAllModel(image: Assets.lucky16EtaQ, id: 11),
    GridAllModel(image: Assets.lucky16ChidiQ, id: 12),
    GridAllModel(image: Assets.lucky16HeartJ, id: 13),
    GridAllModel(image: Assets.lucky16HukumJ, id: 14),
    GridAllModel(image: Assets.lucky16EtaJ, id: 15),
    GridAllModel(image: Assets.lucky16ChidiJ, id: 16),
  ];
  ...
  void connectToServer(context) async {
    ...
    _socket.on(Lucky16ApiUrl.timerEvent, (timerData) {
      ...
      if (receiveData['timerStatus'] == 1 &&
        ...
        betBool = false;
        setMessage('NO MORE PLAY');
        if (addLucky16Bets.isNotEmpty && betBool == false) {
          lucky16BetViewModel.lucky16BetApi(addLucky16Bets, context);
          betBool = true;
        }
      }
      // start wheel
