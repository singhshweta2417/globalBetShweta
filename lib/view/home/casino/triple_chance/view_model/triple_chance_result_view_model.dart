...
class TripleChanceResultViewModel with ChangeNotifier {
  ...
  List<ResultTripleChance> get tripleChanceResultList =>
      _tripleChanceResultList;
      ...
      if (value.success == true) {
        if (status == 1) {
          ...
          tripleChanceController
              .firstStop(value.resultTripleChance!.first.wheel1Index!);
          tripleChanceController
              .secondStop(value.resultTripleChance!.first.wheel2Index!);
          tripleChanceController
              .thirdStop(value.resultTripleChance!.first.wheel3Index!);
          Future.delayed(const Duration(seconds: 4), () {
            ...
            if (value.winAmount != 0) {
              ...
              Utils.showTrChWinToast(
                  value.winAmount.toString(),
                  value.firstWheelAmount.toString(),
                  value.secWheelAmount.toString(),
                  value.thirdWheelAmount.toString(),
                  context);
            }
          });
        }
