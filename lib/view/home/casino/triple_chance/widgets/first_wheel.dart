...
class FirstWheelSpin extends StatefulWidget {
  ...
  @override
  State<FirstWheelSpin> createState() => _BlueWheelSpinState(controller);
}

class _BlueWheelSpinState extends State<FirstWheelSpin>
    with TickerProviderStateMixin {
  _BlueWheelSpinState(TripleChanceController controller) {
    controller.firstStartWheel = startWheel;
    controller.firstStopWheel = stopWheel;
  }
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage(widget.pathImage),fit: BoxFit.cover,
                )
            ),
          ),
        ));
