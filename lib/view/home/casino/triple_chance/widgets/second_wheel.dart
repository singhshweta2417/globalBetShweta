...
class SecondWheelSpin extends StatefulWidget {
  ...
  @override
  State<SecondWheelSpin> createState() => _SecondWheelSpinState(controller);
}

class _SecondWheelSpinState extends State<SecondWheelSpin>
    with TickerProviderStateMixin {
  _SecondWheelSpinState(TripleChanceController controller) {
    controller.secondStartWheel = startWheel;
    controller.secondStopWheel = stopWheel;
  }
