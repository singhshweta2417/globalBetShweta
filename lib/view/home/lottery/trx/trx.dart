...
import 'package:globalbet/view/home/lottery/trx/widgets/trx_bottom_sheet.dart';
import 'package:globalbet/view/home/lottery/trx/widgets/trx_tab.dart';
import 'package:globalbet/view/home/lottery/trx/widgets/trx_wallet.dart';
                ...
                children: List.generate(dataList.length, (index) {
                  ...
                  return Container(
                    ...
                    child: index!=dataList.length - 1? textWidget(
                      text: dataList[index].toUpperCase(),
                ...
                children: List.generate(trc.colorBetList.length, (index) {
                  return InkWell(
                    ...
                    child: Container(
                      ...
                      child: textWidget(
                        text: trc.colorBetList[index].title,
                        fontSize: 16,
                        fontWeight: FontWeight.w600,
                        color: TrxColors.whiteColor,
                      ),
                ...
                children: List.generate(trc.bigSmallList.length, (index) {
                  return InkWell(
                    ...
                    child: Container(
                      ...
                      child:  textWidget(
                        text: trc.bigSmallList[index].title,
                        color: TrxColors.whiteColor,
                        fontSize: 18,
                        fontWeight: FontWeight.bold,
                      ),
