              ...
              child: Column(
                children: [
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: textWidget(
                                        ...
                                        text: wgc.balanceList[idx].toString(),
                                        fontSize: 18,
                  ...
                  Row(
                    ...
                    children: [
                       textWidget(
                          text: "Quantity", fontSize: 18, color: Colors.grey),
                        ...
                        return Padding(
                            ...
                            child: InkWell(
                              ...
                              child: Container(
                                ...
                                child: Center(
                                  child: textWidget(
                                    text: "X${wgc.multiplierList[index]}",
                                    fontSize: 15,
                                    fontWeight: FontWeight.w500,
                    ...
                    children: [
                      InkWell(
                        ...
                        child: Container(
                          ...
                          height: 45,
                          child:  textWidget(
                              text: "Cancel", color: Colors.white, fontSize: 20),
                        ),
                      ),
                      InkWell(
                        onTap: () {
          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                  textWidget(
                    text: wingoGameController.gameTimerList[
