...
import 'package:globalbet/view/home/mini/kino_home_directory/kiNo_appbar.dart';
...
class KinoGame extends StatefulWidget {
  const KinoGame({super.key});

  @override
  _KinoGameState createState() => _KinoGameState();
}

class _KinoGameState extends State<KinoGame> {
