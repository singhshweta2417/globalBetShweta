        ...
        child: Scaffold(
          bottomSheet: Container(
            ...
            decoration: const BoxDecoration(
                ...
                gradient: MineColor.loginSecondaryGrad),
            child: Column(
              children: [
                SizedBox(
                  height: height * 0.02,
                ...
                mic.cashOut == false
                    ? InkWell(
                        onTap: () {
                          if (profileViewModel.balance <
                              int.parse(mic.amountCon.text)) {
                            Utils.flushBarErrorMessage(
                                "Insufficient Balance", context, Colors.red);
                          } else {
                            mic.setCashOut(true);
                            mic.refreshGame();
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  'Cash Out:${mic.amountValue.toStringAsFixed(2)} RS',
                                  style: const TextStyle(
                                      color: Colors.white,
                                      fontWeight: FontWeight.w900,
                                      fontSize: 16),
          ...
          body: Container(
            ...
            width: width,
            decoration:
                const BoxDecoration(gradient: MineColor.minesBgGradient),
            child: SafeArea(
              child: ListView(
