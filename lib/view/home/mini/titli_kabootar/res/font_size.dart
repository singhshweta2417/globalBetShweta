...
const double textFontSize17 = 17;
...
const spaceWidth25 = SizedBox(width: 25);
const spaceWidth30 = SizedBox(width: 30);
const spaceWidth35 = SizedBox(width: 35);
...
const spaceHeight25 = SizedBox(height: 25);
const spaceHeight30 = SizedBox(height: 30);
const spaceHeight50 = SizedBox(height: 50);
const spaceHeight80 = SizedBox(height: 80);
const spaceHeight180 = SizedBox(height: 180);
