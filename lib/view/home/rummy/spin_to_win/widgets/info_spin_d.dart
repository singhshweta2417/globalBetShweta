            ...
            SizedBox(
              ...
              child: Table(
                ...
                children: [
                  ...
                  tableData('Singles Play', '5', '100000',context),
                ],
              ),
            ),
            const Text(
            ...
            children: List.generate(
              ...
              if (index == 0) {
                return Row(
                    ...
                    children: [
                      commonWidget('SR.NO', height * 0.2),
                      commonWidget('GAME REF NO', height * 0.45),
              ...
              return Row(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: [
                    commonWidget(index.toString(), height * 0.2,
                        fotSize: 20
                    ),
                    commonWidget('${resData.periodNo}', height * 0.45,
                        fotSize: 20
                    ),
                    commonWidget('${resData.amount}', height * 0.2,
                        fotSize: 20
                    ),
                    commonWidget('${resData.winAmount}', height * 0.2,
                        fotSize: 20
                    ),
